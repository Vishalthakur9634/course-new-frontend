                    ...
                    {wishlist.map(course => (
                        ...
                        >
                            ...
                            <div className="p-4 md:p-8 flex-1 flex flex-col space-y-3 md:space-y-4">
                                <h3 className="text-base md:text-xl font-bold text-white uppercase tracking-tight leading-tight group-hover:text-brand-primary transition-colors line-clamp-2">
                                    {course.title}
                                </h3>
                                <p className="text-dark-muted text-[10px] md:text-xs font-medium line-clamp-2 leading-relaxed">
                                    {course.description}
                                </p>
                                <div className="mt-auto pt-4 md:pt-6 border-t border-white/5 flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        <p className="text-[8px] md:text-[9px] font-bold text-dark-muted uppercase tracking-widest opacity-60">Enrollment Fee</p>
                                    ...
                                    <Link
                                        ...
                                        className="bg-brand-primary hover:brightness-110 text-dark-bg px-4 md:px-6 py-2 md:py-2.5 rounded-lg text-[9px] md:text-[10px] font-bold uppercase tracking-widest transition-all shadow-lg"
                                    >
                                        Begin
                                    </Link>
                                </div>
